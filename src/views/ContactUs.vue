            ...
            <form @submit.prevent="" class="w-full flex flex-wrap">
              <div class="w-full flex flex-wrap">
                <div class="w-1/2 p-2">
                  ...
                  <DefaultInput
                    input_type="text"
                    input_class="border-1 border-[#e3e3e3] p-2 w-full mt-[5px]"
                ...
                <div class="w-1/2 p-2">
                  ...
                  <DefaultInput
                    input_type="number"
                    input_class="border-1 border-[#e3e3e3] p-2 w-full mt-[5px]"
                    input_placeholder="Enter Your Phone"
                    is_required="true"
                  />
                </div>
                <div class="w-1/2 p-2">
                ...
                <div class="w-1/2 p-2">
                  ...
                  <DefaultInput
                    input_type="number"
                    input_class="border-1 border-[#e3e3e3] p-2 w-full mt-[5px]"
                    input_placeholder="Company Phone"
                    is_required="true"
                  />
                </div>
                ...
                <div class="w-full p-2">
                  <DefaultInput
                    input_type="checkbox"
                    input_class="border-1 border-[#e3e3e3] p-2 w-fit mt-[5px]"
                    is_required="true"
                  />
